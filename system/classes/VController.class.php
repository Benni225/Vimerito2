<?
    ...
    *
    */
    class VController extends VView{
        ...
        */ 
        public function __construct(){
            ...
            $this->registerMethodAlias("useJavaScriptLibraries", array("VLayout", "registerUserJavaScriptLibraries"));
        }
        ...
        public function __call($method, $parameters){
            try{
                if(method_exists($this, $method)){
                    ...
                    if(is_string($this->_methods[$method])){
                        ...
                        eval($func);
                        return $_return;
                    }elseif(is_array($this->_methods[$method])){
                        //is a static method
        ...
        */ 
        public function registerMethodAlias($alias, $callback){
            if(is_string($callback) and is_array($callback)){
